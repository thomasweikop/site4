            ...
            <thead className="bg-paper">
              <tr>
                ...
                {MATRIX_COLUMNS.map((column) => (
                  <th
                    key={column.key}
                    className="h-[150px] w-[44px] border-b border-line px-1 py-2 align-bottom text-center font-semibold text-ink"
                  >
                ...
                >
                  ...
                  {MATRIX_COLUMNS.map((column) => (
                    <td
                      ...
                      className="px-2 py-4 text-center text-lg leading-none text-[#2a5a4f]"
                    >
