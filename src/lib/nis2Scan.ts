...
export const SCORE_BANDS = [
  {
    ...
    min: 80,
    range: "80–100",
    status: "Solidt udgangspunkt",
    risk: "Screeningen peger stadig på opfølgning",
    className: "bg-[#dce8dc] text-sage border-[#b6cfb6]",
    barClassName: "bg-sage",
    summary:
      "Virksomheden har et relativt solidt udgangspunkt i screeningen, men resultatet er ikke et bevis på fuld compliance og de laveste områder bør stadig prioriteres.",
  },
  {
    id: "medium",
    min: 60,
    ...
    risk: "Tydelige områder bør prioriteres",
  ...
  },
  {
    ...
    risk: "Væsentlige områder kræver handling",
  ...
  },
  {
    ...
    risk: "Kritiske områder kræver hurtig handling",
    className: "bg-[#f4ddd6] text-ember border-[#e0a291]",
    barClassName: "bg-ember",
    summary:
